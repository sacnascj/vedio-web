...
const constantRouterMap = [
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          {
            path: 'updateThingView',
            name: 'updateThingView',
            component: () => import('/@/views/index/user/update-thing-view.vue')
          },
          {
            path: 'wishThingView',
            name: 'wishThingView',
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'thing_sh', name: 'thing_sh', component: () => import('/@/views/admin/thingsh.vue') },
